      ...
      {hotspots.map((hotspot) => {
        ...
        return (
          <button
            ...
            className={`absolute group transition-opacity ${animationClass} ${debug ? "border-2 border-dashed border-emerald-500/50 bg-emerald-500/10" : "border-none"} ${hotspot.type === "item" && !itemsRevealed && !debug ? "pointer-events-none" : ""}`}
            style={{
              top: hotspot.top,
              left: hotspot.left,
              width: hotspot.width,
